...
import edge_tts # Import edge_tts for asychronous operations.
...
def TTS(Text, func=lambda r=None: True):
    while True:
        try:
            ...
            # Load until the audio is done playing or the function stops.
...
def TextToSpeech(Text, func=lambda r=None: True):
    ...
    # List of predefineded responses for cases where the text is too long.
